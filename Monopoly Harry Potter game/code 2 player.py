...
class Player:
    ...
    def afterRoll(self,a,whoseturn,listofusers):
        ...
        if self.money==0 and self.huts==0 and self.manors==0 and self.unmortgagedProperties==[]:
            tempwn=Tk()
            tempwn.withdraw()
        ...
        if self.gameplay.propertydictionary[self.position] in self.gameplay.player2.unmortgagedProperties:
